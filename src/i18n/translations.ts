...
const translations: Record<Language, TranslationKeys> = {
  ...
  // New languages - using English fallback via t() function for untranslated keys
  ur: {
    appName: 'Agro_Guardian', login: 'لاگ ان', signup: 'سائن اپ', logout: 'لاگ آؤٹ', back: 'واپس', save: 'محفوظ کریں', settings: 'ترتیبات', profile: 'پروفائل', language: 'زبان',
    heroTitle: 'AI ذہانت سے کسانوں کو بااختیار بنانا', heroDesc: 'ذاتی فصل سفارشات اور فوری بیماری کی پیشگوئی حاصل کریں۔', getStarted: 'شروع کریں — یہ مفت ہے',
    loginTitle: 'Agro_Guardian میں لاگ ان کریں', signupTitle: 'اپنا اکاؤنٹ بنائیں', emailOrPhone: 'ای میل یا فون', password: 'پاس ورڈ', fullName: 'پورا نام', phone: 'فون', emailOptional: 'ای میل (اختیاری)', state: 'ریاست', district: 'ضلع', createPassword: 'پاس ورڈ بنائیں', createAccount: 'اکاؤنٹ بنائیں', continueWithGmail: 'Gmail سے جاری رکھیں', signupWithGmail: 'Gmail سے سائن اپ', selectState: 'ریاست منتخب کریں', yourDistrict: 'آپ کا ضلع',
    welcomeFarmer: 'خوش آمدید، کسان! 🌾', chooseService: 'شروع کرنے کے لیے سروس منتخب کریں', cropRecommendation: 'فصل سفارش', cropRecommendationDesc: 'اپنی مٹی، موسم اور بجٹ کی بنیاد پر بہترین فصل کے لیے AI سفارشات حاصل کریں۔', cropDiseasePrediction: 'فصل کی بیماری کی پیشگوئی', cropDiseaseDesc: 'اپنی فصل کی تصویر اپلوڈ کریں اور ہمارا AI بیماری کی شناخت کرے گا۔',
    chooseMode: 'اپنا پسندیدہ ان پٹ موڈ منتخب کریں', simpleMode: 'سادہ موڈ', simpleModeDesc: 'مٹی کی قسم، بجٹ، موسم اور سیزن جیسی بنیادی معلومات درج کریں۔', advancedMode: 'ایڈوانسڈ موڈ', advancedModeDesc: 'تفصیلی سائنسی تجزیے کے لیے N, P, K اقدار درج کریں۔',
    soilType: 'مٹی کی قسم', budget: 'بجٹ (₹)', weatherLocation: 'موجودہ موسم / مقام', season: 'سیزن', getRecommendation: 'سفارش حاصل کریں 🌱',
    nitrogen: 'نائٹروجن (N) %', phosphorus: 'فاسفورس (P) %', potassium: 'پوٹاشیم (K) %', temperature: 'درجہ حرارت (°C)', humidity: 'نمی (%)', phValue: 'pH قدر', rainfall: 'بارش (ملی میٹر)', analyzeRecommend: 'تجزیہ اور سفارش 🔬',
    uploadOrCapture: 'متاثرہ فصل کی تصویر اپلوڈ کریں', clickToUpload: 'اپلوڈ کرنے کے لیے کلک کریں', uploadImage: 'تصویر اپلوڈ', useCamera: 'کیمرا استعمال کریں', supportedFormats: 'معاون فارمیٹ: JPG, PNG, WebP', maxFileSize: 'زیادہ سے زیادہ فائل سائز: 10 MB', blurryWarning: 'تصویر دھندلی ہو سکتی ہے۔ واضح تصویر دوبارہ اپلوڈ کریں۔', predictDisease: 'بیماری کی پیشگوئی کریں 🔍',
    confidence: 'اعتماد', cropSchedule: 'فصل شیڈول', nextCropRotation: 'اگلی فصل کی تبدیلی', recommendedFertilizers: 'تجویز کردہ کھاد', preventionTreatment: 'روک تھام اور علاج', fertilizerSuggestion: 'کھاد تجویز',
    weatherIntegration: 'موسم API انضمام', voiceInput: 'آواز پر مبنی ان پٹ', cropRotationPlanner: 'فصل چکر اور مٹی بحالی منصوبہ ساز', smsAlerts: 'SMS الرٹ سسٹم', cropScheduleFeature: 'مکمل فصل شیڈول', fertilizerYield: 'فصل کی پیداوار کے لیے کھاد', diseaseStage: 'بیماری کا مرحلہ اور انفیکشن کی سطح', imageQuality: 'تصویر کے معیار کا تجزیہ کار',
    appLanguage: 'ایپ زبان', chooseLanguage: 'ایپ انٹرفیس کے لیے اپنی پسندیدہ زبان منتخب کریں۔', saveSettings: 'ترتیبات محفوظ کریں', myProfile: 'میری پروفائل', updateProfile: 'پروفائل اپ ڈیٹ کریں', phoneNumber: 'فون نمبر', email: 'ای میل',
    footerDesc: 'ہندوستانی کسانوں کے لیے AI سے چلنے والی فصل سفارش اور بیماری کی پیشگوئی', allRightsReserved: '© 2026 Agro_Guardian. جملہ حقوق محفوظ ہیں۔',
    selectLocation: 'نقشے پر اپنا مقام منتخب کریں', mapTitle: 'ہندوستان کا نقشہ — اپنا علاقہ منتخب کریں',
  },
  kok: {
    appName: 'Agro_Guardian', login: 'लॉगिन', signup: 'साइन अप', logout: 'लॉगआउट', back: 'फाटीं', save: 'सांबाळ', settings: 'सेटिंग्ज', profile: 'प्रोफाइल', language: 'भास',
    heroTitle: 'AI बुद्धिमत्तेन शेतकाऱ्यांक सशक्त करप', heroDesc: 'वैयक्तिक पीक शिफारशी आनी त्वरित रोग अदमास मेळयात।', getStarted: 'सुरू करात — हें फुकट आसा',
    loginTitle: 'Agro_Guardian ंत लॉगिन करात', signupTitle: 'तुमचें खातें तयार करात', emailOrPhone: 'ईमेल वा फोन', password: 'पासवर्ड', fullName: 'पुराय नांव', phone: 'फोन', emailOptional: 'ईमेल (वैकल्पिक)', state: 'राज्य', district: 'जिल्हो', createPassword: 'पासवर्ड तयार करात', createAccount: 'खातें तयार करात', continueWithGmail: 'Gmail वरवीं मुखार वचात', signupWithGmail: 'Gmail वरवीं साइन अप', selectState: 'राज्य निवडात', yourDistrict: 'तुमचो जिल्हो',
    welcomeFarmer: 'येवकार, शेतकाऱ्या! 🌾', chooseService: 'सुरू करपाक सेवा निवडात', cropRecommendation: 'पीक शिफारस', cropRecommendationDesc: 'तुमची माती, हवामान आनी बजेट हांचेर आदारीत AI शिफारशी मेळयात।', cropDiseasePrediction: 'पीक रोग अदमास', cropDiseaseDesc: 'तुमच्या पिकाची तस्वीर अपलोड करात आनी आमचो AI रोग वळखतलो।',
    chooseMode: 'तुमचो आवडिचो इनपुट मोड निवडात', simpleMode: 'सोंपो मोड', simpleModeDesc: 'माती प्रकार, बजेट, हवामान आनी हंगाम अशी मुळावी म्हायती भरात।', advancedMode: 'प्रगत मोड', advancedModeDesc: 'विस्तृत विज्ञानीक विश्लेषणा खातीर N, P, K मूल्यां भरात।',
    soilType: 'माती प्रकार', budget: 'बजेट (₹)', weatherLocation: 'सद्याचें हवामान / सुवात', season: 'हंगाम', getRecommendation: 'शिफारस मेळयात 🌱',
    nitrogen: 'नायट्रोजन (N) %', phosphorus: 'फॉस्फरस (P) %', potassium: 'पोटॅशियम (K) %', temperature: 'तापमान (°C)', humidity: 'आर्द्रता (%)', phValue: 'pH मूल्य', rainfall: 'पावस (मिमी)', analyzeRecommend: 'विश्लेषण आनी शिफारस 🔬',
    uploadOrCapture: 'प्रभावित पिकाचो फोटो अपलोड करात', clickToUpload: 'अपलोड करपाक क्लिक करात', uploadImage: 'तस्वीर अपलोड', useCamera: 'कॅमेरा वापरात', supportedFormats: 'समर्थित फॉर्मेट: JPG, PNG, WebP', maxFileSize: 'वरिश्ठ फायल आकार: 10 MB', blurryWarning: 'तस्वीर अस्पश्ट आसूं येता। स्पश्ट फोटो परत अपलोड करात।', predictDisease: 'रोग अदमास करात 🔍',
    confidence: 'विश्वासार्हताय', cropSchedule: 'पीक वेळापत्रक', nextCropRotation: 'फुडलें पीक चक्र', recommendedFertilizers: 'शिफारस केल्ली सारें', preventionTreatment: 'प्रतिबंध आनी उपचार', fertilizerSuggestion: 'सार सुचोवणी',
    weatherIntegration: 'हवामान API एकत्रीकरण', voiceInput: 'आवाज आदारीत इनपुट', cropRotationPlanner: 'पीक चक्र आनी माती पुनर्प्राप्ती नियोजक', smsAlerts: 'SMS अलर्ट यंत्रणा', cropScheduleFeature: 'पुराय पीक वेळापत्रक', fertilizerYield: 'पीक उत्पन्ना खातीर सार', diseaseStage: 'रोग टप्पो आनी संसर्ग पातळी', imageQuality: 'तस्वीर गुणवत्ता विश्लेषक',
    appLanguage: 'ॲप भास', chooseLanguage: 'ॲप इंटरफेसा खातीर तुमची आवडीची भास निवडात।', saveSettings: 'सेटिंग्ज सांबाळात', myProfile: 'म्हजी प्रोफाइल', updateProfile: 'प्रोफाइल अपडेट करात', phoneNumber: 'फोन नंबर', email: 'ईमेल',
    footerDesc: 'भारतीय शेतकाऱ्यां खातीर AI-चालित पीक शिफारस आनी रोग अदमास', allRightsReserved: '© 2026 Agro_Guardian. सगळे हक्क राखीव.',
    selectLocation: 'नकाशाचेर तुमची सुवात निवडात', mapTitle: 'भारताचो नकाशो — तुमचो वाठार निवडात',
  },
  mni: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'Login', signup: 'Sign Up', logout: 'Logout', back: 'Back', save: 'Save', settings: 'Settings', profile: 'Profile', language: 'Language', heroTitle: 'AI Intelligence না লোয়শিংবু শক্তি পীনবা', heroDesc: 'Personalized crop recommendations and instant disease predictions.', getStarted: 'Start — Free', loginTitle: 'Agro_Guardian Login', signupTitle: 'Create Account', emailOrPhone: 'Email/Phone', password: 'Password', fullName: 'Full Name', phone: 'Phone', emailOptional: 'Email (optional)', state: 'State', district: 'District', createPassword: 'Create Password', createAccount: 'Create Account', continueWithGmail: 'Continue with Gmail', signupWithGmail: 'Sign up with Gmail', selectState: 'Select state', yourDistrict: 'Your district', welcomeFarmer: 'Welcome, Farmer! 🌾', chooseService: 'Choose a service', cropRecommendation: 'Crop Recommendation', cropRecommendationDesc: 'AI-powered crop suggestions.', cropDiseasePrediction: 'Crop Disease Prediction', cropDiseaseDesc: 'Upload crop image for AI diagnosis.', chooseMode: 'Choose input mode', simpleMode: 'Simple Mode', simpleModeDesc: 'Basic info input.', advancedMode: 'Advanced Mode', advancedModeDesc: 'Detailed scientific input.', soilType: 'Soil Type', budget: 'Budget (₹)', weatherLocation: 'Weather/Location', season: 'Season', getRecommendation: 'Get Recommendation 🌱', nitrogen: 'Nitrogen (N) %', phosphorus: 'Phosphorus (P) %', potassium: 'Potassium (K) %', temperature: 'Temperature (°C)', humidity: 'Humidity (%)', phValue: 'pH Value', rainfall: 'Rainfall (mm)', analyzeRecommend: 'Analyze & Recommend 🔬', uploadOrCapture: 'Upload or capture crop photo', clickToUpload: 'Click to upload', uploadImage: 'Upload Image', useCamera: 'Use Camera', supportedFormats: 'Formats: JPG, PNG, WebP', maxFileSize: 'Max: 10 MB', blurryWarning: 'Image may be blurry. Re-upload clearer photo.', predictDisease: 'Predict Disease 🔍', confidence: 'Confidence', cropSchedule: 'Crop Schedule', nextCropRotation: 'Next Crop Rotation', recommendedFertilizers: 'Recommended Fertilizers', preventionTreatment: 'Prevention & Treatment', fertilizerSuggestion: 'Fertilizer Suggestion', weatherIntegration: 'Weather Integration', voiceInput: 'Voice Input', cropRotationPlanner: 'Crop Rotation Planner', smsAlerts: 'SMS Alerts', cropScheduleFeature: 'Complete Crop Schedule', fertilizerYield: 'Fertilizer for Yield', diseaseStage: 'Disease Stage & Infection', imageQuality: 'Image Quality Analyzer', appLanguage: 'App Language', chooseLanguage: 'Choose your preferred language.', saveSettings: 'Save Settings', myProfile: 'My Profile', updateProfile: 'Update Profile', phoneNumber: 'Phone Number', email: 'Email', footerDesc: 'AI-powered crop recommendation & disease prediction', allRightsReserved: '© 2026 Agro_Guardian. All rights reserved.', selectLocation: 'Select location on map', mapTitle: 'India Map — Select Region' },
  ne: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'लगइन', signup: 'साइन अप', logout: 'लगआउट', back: 'पछाडि', save: 'बचत गर्नुहोस्', settings: 'सेटिङहरू', profile: 'प्रोफाइल', language: 'भाषा', heroTitle: 'AI बुद्धिमत्ताले किसानहरूलाई सशक्त बनाउँदै', heroDesc: 'व्यक्तिगत बाली सिफारिस र तत्काल रोग भविष्यवाणी प्राप्त गर्नुहोस्।', getStarted: 'सुरू गर्नुहोस् — निःशुल्क', loginTitle: 'Agro_Guardian मा लगइन', signupTitle: 'खाता बनाउनुहोस्', emailOrPhone: 'इमेल वा फोन', password: 'पासवर्ड', fullName: 'पूरा नाम', phone: 'फोन', emailOptional: 'इमेल (वैकल्पिक)', state: 'राज्य', district: 'जिल्ला', createPassword: 'पासवर्ड बनाउनुहोस्', createAccount: 'खाता बनाउनुहोस्', continueWithGmail: 'Gmail बाट जारी राख्नुहोस्', signupWithGmail: 'Gmail बाट साइन अप', selectState: 'राज्य छान्नुहोस्', yourDistrict: 'तपाईंको जिल्ला', welcomeFarmer: 'स्वागत छ, किसान! 🌾', chooseService: 'सुरू गर्न सेवा छान्नुहोस्', cropRecommendation: 'बाली सिफारिस', cropRecommendationDesc: 'AI-संचालित बाली सुझावहरू।', cropDiseasePrediction: 'बाली रोग भविष्यवाणी', cropDiseaseDesc: 'AI निदानको लागि बालीको तस्बिर अपलोड गर्नुहोस्।', chooseMode: 'इनपुट मोड छान्नुहोस्', simpleMode: 'सरल मोड', simpleModeDesc: 'आधारभूत जानकारी।', advancedMode: 'उन्नत मोड', advancedModeDesc: 'विस्तृत वैज्ञानिक विश्लेषण।', soilType: 'माटोको प्रकार', budget: 'बजेट (₹)', weatherLocation: 'हालको मौसम / स्थान', season: 'ऋतु', getRecommendation: 'सिफारिस प्राप्त गर्नुहोस् 🌱', nitrogen: 'नाइट्रोजन (N) %', phosphorus: 'फस्फोरस (P) %', potassium: 'पोटासियम (K) %', temperature: 'तापक्रम (°C)', humidity: 'आर्द्रता (%)', phValue: 'pH मान', rainfall: 'वर्षा (मिमी)', analyzeRecommend: 'विश्लेषण र सिफारिस 🔬', uploadOrCapture: 'प्रभावित बालीको फोटो अपलोड गर्नुहोस्', clickToUpload: 'अपलोड गर्न क्लिक गर्नुहोस्', uploadImage: 'तस्बिर अपलोड', useCamera: 'क्यामेरा प्रयोग गर्नुहोस्', supportedFormats: 'ढाँचाहरू: JPG, PNG, WebP', maxFileSize: 'अधिकतम: 10 MB', blurryWarning: 'तस्बिर धमिलो हुन सक्छ। स्पष्ट फोटो पुन: अपलोड गर्नुहोस्।', predictDisease: 'रोग भविष्यवाणी गर्नुहोस् 🔍', confidence: 'विश्वसनीयता', cropSchedule: 'बाली तालिका', nextCropRotation: 'अर्को बाली चक्र', recommendedFertilizers: 'सिफारिस गरिएका मल', preventionTreatment: 'रोकथाम र उपचार', fertilizerSuggestion: 'मल सुझाव', weatherIntegration: 'मौसम एकीकरण', voiceInput: 'आवाज इनपुट', cropRotationPlanner: 'बाली चक्र योजनाकार', smsAlerts: 'SMS अलर्ट', cropScheduleFeature: 'पूर्ण बाली तालिका', fertilizerYield: 'उपजको लागि मल', diseaseStage: 'रोग चरण र संक्रमण', imageQuality: 'तस्बिर गुणस्तर विश्लेषक', appLanguage: 'एप भाषा', chooseLanguage: 'आफ्नो मनपर्ने भाषा छान्नुहोस्।', saveSettings: 'सेटिङ बचत गर्नुहोस्', myProfile: 'मेरो प्रोफाइल', updateProfile: 'प्रोफाइल अपडेट', phoneNumber: 'फोन नम्बर', email: 'इमेल', footerDesc: 'भारतीय किसानहरूको लागि AI-संचालित बाली सिफारिस र रोग भविष्यवाणी', allRightsReserved: '© 2026 Agro_Guardian. सबै अधिकार सुरक्षित।', selectLocation: 'नक्सामा स्थान छान्नुहोस्', mapTitle: 'भारत नक्सा — क्षेत्र छान्नुहोस्' },
  mai: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'लॉगिन', signup: 'साइन अप', logout: 'लॉगआउट', back: 'वापस', save: 'सहेजू', settings: 'सेटिंग्स', profile: 'प्रोफाइल', language: 'भाषा', heroTitle: 'AI बुद्धिमत्ता सँ किसान केँ सशक्त बनाबय', heroDesc: 'व्यक्तिगत फसल सिफारिश आ तत्काल रोग भविष्यवाणी प्राप्त करू।', getStarted: 'शुरू करू — ई मुफ्त अछि', loginTitle: 'Agro_Guardian मे लॉगिन', signupTitle: 'अपन खाता बनाउ', emailOrPhone: 'ईमेल या फोन', password: 'पासवर्ड', fullName: 'पूरा नाम', phone: 'फोन', emailOptional: 'ईमेल (वैकल्पिक)', state: 'राज्य', district: 'जिला', createPassword: 'पासवर्ड बनाउ', createAccount: 'खाता बनाउ', continueWithGmail: 'Gmail सँ जारी रखू', signupWithGmail: 'Gmail सँ साइन अप', selectState: 'राज्य चुनू', yourDistrict: 'अहाँक जिला', welcomeFarmer: 'स्वागत अछि, किसान! 🌾', chooseService: 'शुरू करय लेल सेवा चुनू', cropRecommendation: 'फसल सिफारिश', cropRecommendationDesc: 'AI-संचालित फसल सुझाव।', cropDiseasePrediction: 'फसल रोग भविष्यवाणी', cropDiseaseDesc: 'AI निदान लेल फसलक तस्वीर अपलोड करू।', chooseMode: 'इनपुट मोड चुनू', simpleMode: 'सरल मोड', simpleModeDesc: 'मूल जानकारी।', advancedMode: 'उन्नत मोड', advancedModeDesc: 'विस्तृत वैज्ञानिक विश्लेषण।', soilType: 'माटिक प्रकार', budget: 'बजट (₹)', weatherLocation: 'वर्तमान मौसम / स्थान', season: 'ऋतु', getRecommendation: 'सिफारिश प्राप्त करू 🌱', nitrogen: 'नाइट्रोजन (N) %', phosphorus: 'फास्फोरस (P) %', potassium: 'पोटैशियम (K) %', temperature: 'तापमान (°C)', humidity: 'आर्द्रता (%)', phValue: 'pH मान', rainfall: 'वर्षा (मिमी)', analyzeRecommend: 'विश्लेषण आ सिफारिश 🔬', uploadOrCapture: 'प्रभावित फसलक फोटो अपलोड करू', clickToUpload: 'अपलोड करय लेल क्लिक करू', uploadImage: 'तस्वीर अपलोड', useCamera: 'कैमरा इस्तेमाल करू', supportedFormats: 'समर्थित फॉर्मेट: JPG, PNG, WebP', maxFileSize: 'अधिकतम: 10 MB', blurryWarning: 'तस्वीर धुंधला भ सकैत अछि।', predictDisease: 'रोग भविष्यवाणी करू 🔍', confidence: 'विश्वसनीयता', cropSchedule: 'फसल कार्यक्रम', nextCropRotation: 'अगिला फसल चक्र', recommendedFertilizers: 'अनुशंसित उर्वरक', preventionTreatment: 'रोकथाम आ उपचार', fertilizerSuggestion: 'उर्वरक सुझाव', weatherIntegration: 'मौसम एकीकरण', voiceInput: 'आवाज इनपुट', cropRotationPlanner: 'फसल चक्र योजनाकार', smsAlerts: 'SMS अलर्ट', cropScheduleFeature: 'पूर्ण फसल कार्यक्रम', fertilizerYield: 'उपज लेल उर्वरक', diseaseStage: 'रोग चरण आ संक्रमण', imageQuality: 'तस्वीर गुणवत्ता विश्लेषक', appLanguage: 'ऐप भाषा', chooseLanguage: 'अपन पसंदीदा भाषा चुनू।', saveSettings: 'सेटिंग्स सहेजू', myProfile: 'हमर प्रोफाइल', updateProfile: 'प्रोफाइल अपडेट', phoneNumber: 'फोन नंबर', email: 'ईमेल', footerDesc: 'भारतीय किसान लेल AI-संचालित फसल सिफारिश', allRightsReserved: '© 2026 Agro_Guardian. सर्वाधिकार सुरक्षित।', selectLocation: 'नक्शा पर स्थान चुनू', mapTitle: 'भारत नक्शा — क्षेत्र चुनू' },
  doi: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'लॉगिन', signup: 'साइन अप', logout: 'लॉगआउट', back: 'पिच्छे', save: 'सम्भालो', settings: 'सेटिंग्स', profile: 'प्रोफाइल', language: 'भाशा', heroTitle: 'AI बुद्धिमत्ता कन्नै किसानें गी सशक्त बनाना', heroDesc: 'निजी फसल सिफारशां ते तुरंत रोग भविष्यवाणी हासल करो।', getStarted: 'शुरू करो — एह् मुफ्त ऐ', loginTitle: 'Agro_Guardian च लॉगिन करो', signupTitle: 'अपना खाता बनाओ', emailOrPhone: 'ईमेल या फोन', password: 'पासवर्ड', fullName: 'पूरा नांऽ', phone: 'फोन', emailOptional: 'ईमेल (वैकल्पिक)', state: 'राज्य', district: 'जिल्हा', createPassword: 'पासवर्ड बनाओ', createAccount: 'खाता बनाओ', continueWithGmail: 'Gmail कन्नै जारी रक्खो', signupWithGmail: 'Gmail कन्नै साइन अप', selectState: 'राज्य चुनो', yourDistrict: 'तुन्दा जिल्हा', welcomeFarmer: 'जी आयां नूं, किसान! 🌾', chooseService: 'शुरू करने आस्तै सेवा चुनो', cropRecommendation: 'फसल सिफारश', cropRecommendationDesc: 'AI-संचालित फसल सुझाव।', cropDiseasePrediction: 'फसल रोग भविष्यवाणी', cropDiseaseDesc: 'AI निदान आस्तै फसल दी तस्वीर अपलोड करो।', chooseMode: 'इनपुट मोड चुनो', simpleMode: 'सरल मोड', simpleModeDesc: 'बुनियादी जानकारी।', advancedMode: 'उन्नत मोड', advancedModeDesc: 'विस्तृत वैज्ञानिक विश्लेषण।', soilType: 'मिट्टी दा प्रकार', budget: 'बजट (₹)', weatherLocation: 'मौजूदा मौसम / जगह', season: 'मौसम', getRecommendation: 'सिफारश हासल करो 🌱', nitrogen: 'नाइट्रोजन (N) %', phosphorus: 'फास्फोरस (P) %', potassium: 'पोटैशियम (K) %', temperature: 'तापमान (°C)', humidity: 'नमी (%)', phValue: 'pH मूल्य', rainfall: 'बरखा (मिमी)', analyzeRecommend: 'विश्लेषण ते सिफारश 🔬', uploadOrCapture: 'प्रभावित फसल दा फोटो अपलोड करो', clickToUpload: 'अपलोड करने आस्तै क्लिक करो', uploadImage: 'तस्वीर अपलोड', useCamera: 'कैमरा इस्तेमाल करो', supportedFormats: 'फॉर्मेट: JPG, PNG, WebP', maxFileSize: 'अधिकतम: 10 MB', blurryWarning: 'तस्वीर धुंधली होई सकदी ऐ।', predictDisease: 'रोग भविष्यवाणी करो 🔍', confidence: 'विश्वसनीयता', cropSchedule: 'फसल कार्यक्रम', nextCropRotation: 'अगली फसल चक्र', recommendedFertilizers: 'सिफारश कीती खाद', preventionTreatment: 'रोकथाम ते उपचार', fertilizerSuggestion: 'खाद सुझाव', weatherIntegration: 'मौसम एकीकरण', voiceInput: 'आवाज इनपुट', cropRotationPlanner: 'फसल चक्र योजनाकार', smsAlerts: 'SMS अलर्ट', cropScheduleFeature: 'पूरा फसल कार्यक्रम', fertilizerYield: 'उपज आस्तै खाद', diseaseStage: 'रोग चरण ते संक्रमण', imageQuality: 'तस्वीर गुणवत्ता विश्लेषक', appLanguage: 'ऐप भाशा', chooseLanguage: 'अपनी पसंदीदा भाशा चुनो।', saveSettings: 'सेटिंग्स सम्भालो', myProfile: 'मेरी प्रोफाइल', updateProfile: 'प्रोफाइल अपडेट', phoneNumber: 'फोन नंबर', email: 'ईमेल', footerDesc: 'भारतीय किसानें आस्तै AI-संचालित फसल सिफारश', allRightsReserved: '© 2026 Agro_Guardian. सब अधिकार सुरक्षित।', selectLocation: 'नक्शे पर जगह चुनो', mapTitle: 'भारत नक्शा — क्षेत्र चुनो' },
  sat: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'Login', signup: 'Sign Up', logout: 'Logout', back: 'Back', save: 'Save', settings: 'Settings', profile: 'Profile', language: 'Language', heroTitle: 'AI Intelligence ᱨᱮ ᱠᱤᱥᱟᱱ ᱠᱚᱣᱟᱜ ᱥᱟᱦᱟ', heroDesc: 'Crop recommendations and disease predictions.', getStarted: 'Start — Free', loginTitle: 'Agro_Guardian Login', signupTitle: 'Create Account', emailOrPhone: 'Email/Phone', password: 'Password', fullName: 'Full Name', phone: 'Phone', emailOptional: 'Email (optional)', state: 'State', district: 'District', createPassword: 'Create Password', createAccount: 'Create Account', continueWithGmail: 'Continue with Gmail', signupWithGmail: 'Sign up with Gmail', selectState: 'Select state', yourDistrict: 'Your district', welcomeFarmer: 'Welcome, Farmer! 🌾', chooseService: 'Choose a service', cropRecommendation: 'Crop Recommendation', cropRecommendationDesc: 'AI-powered crop suggestions.', cropDiseasePrediction: 'Crop Disease Prediction', cropDiseaseDesc: 'Upload crop image for AI diagnosis.', chooseMode: 'Choose input mode', simpleMode: 'Simple Mode', simpleModeDesc: 'Basic info input.', advancedMode: 'Advanced Mode', advancedModeDesc: 'Detailed scientific input.', soilType: 'Soil Type', budget: 'Budget (₹)', weatherLocation: 'Weather/Location', season: 'Season', getRecommendation: 'Get Recommendation 🌱', nitrogen: 'Nitrogen (N) %', phosphorus: 'Phosphorus (P) %', potassium: 'Potassium (K) %', temperature: 'Temperature (°C)', humidity: 'Humidity (%)', phValue: 'pH Value', rainfall: 'Rainfall (mm)', analyzeRecommend: 'Analyze & Recommend 🔬', uploadOrCapture: 'Upload or capture crop photo', clickToUpload: 'Click to upload', uploadImage: 'Upload Image', useCamera: 'Use Camera', supportedFormats: 'Formats: JPG, PNG, WebP', maxFileSize: 'Max: 10 MB', blurryWarning: 'Image may be blurry.', predictDisease: 'Predict Disease 🔍', confidence: 'Confidence', cropSchedule: 'Crop Schedule', nextCropRotation: 'Next Crop Rotation', recommendedFertilizers: 'Recommended Fertilizers', preventionTreatment: 'Prevention & Treatment', fertilizerSuggestion: 'Fertilizer Suggestion', weatherIntegration: 'Weather Integration', voiceInput: 'Voice Input', cropRotationPlanner: 'Crop Rotation Planner', smsAlerts: 'SMS Alerts', cropScheduleFeature: 'Complete Crop Schedule', fertilizerYield: 'Fertilizer for Yield', diseaseStage: 'Disease Stage & Infection', imageQuality: 'Image Quality Analyzer', appLanguage: 'App Language', chooseLanguage: 'Choose your preferred language.', saveSettings: 'Save Settings', myProfile: 'My Profile', updateProfile: 'Update Profile', phoneNumber: 'Phone Number', email: 'Email', footerDesc: 'AI-powered crop recommendation & disease prediction', allRightsReserved: '© 2026 Agro_Guardian. All rights reserved.', selectLocation: 'Select location on map', mapTitle: 'India Map — Select Region' },
  ks: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'لاگ اِن', signup: 'سائن اَپ', logout: 'لاگ آوٗٹ', back: 'واپس', save: 'محفوظ', settings: 'سیٹِنگز', profile: 'پروفائل', language: 'زبان', heroTitle: 'AI ذہانت سٕتی کاشتکارَن ہَند سَشکتیکَرَن', heroDesc: 'ذاتی فصل سفارشات تہٕ فوری بیماری پیشگوئی حاصل کَرِو۔', getStarted: 'شروع کَرِو — مُفت', loginTitle: 'Agro_Guardian لاگ اِن', signupTitle: 'اکاؤنٹ بَنٲوِو', emailOrPhone: 'ای میل یا فون', password: 'پاسورڈ', fullName: 'پوٗرٕ ناو', phone: 'فون', emailOptional: 'ای میل (اختیاری)', state: 'ریاست', district: 'ضلع', createPassword: 'پاسورڈ بَنٲوِو', createAccount: 'اکاؤنٹ بَنٲوِو', continueWithGmail: 'Gmail سٕتی جاری رَکھِو', signupWithGmail: 'Gmail سٕتی سائن اَپ', selectState: 'ریاست مُنتَخب کَرِو', yourDistrict: 'تُہُند ضلع', welcomeFarmer: 'خوش آمدید، کاشتکار! 🌾', chooseService: 'سروِس مُنتَخب کَرِو', cropRecommendation: 'فصل سفارش', cropRecommendationDesc: 'AI فصل مشورٕ۔', cropDiseasePrediction: 'فصل بیماری پیشگوئی', cropDiseaseDesc: 'فصل تصویر اپلوڈ کَرِو۔', chooseMode: 'اِنپُٹ موڈ مُنتَخب کَرِو', simpleMode: 'سادٕ موڈ', simpleModeDesc: 'بُنیادی معلومات۔', advancedMode: 'ایڈوانسڈ موڈ', advancedModeDesc: 'تفصیلی سائنسی۔', soilType: 'مٹّی قسم', budget: 'بجٹ (₹)', weatherLocation: 'موسم/مقام', season: 'موسم', getRecommendation: 'سفارش حاصل کَرِو 🌱', nitrogen: 'نائٹروجن %', phosphorus: 'فاسفورس %', potassium: 'پوٹاشیم %', temperature: 'درجہ حرارت °C', humidity: 'نمی %', phValue: 'pH', rainfall: 'بارش mm', analyzeRecommend: 'تجزیہ 🔬', uploadOrCapture: 'فصل فوٹو اپلوڈ', clickToUpload: 'اپلوڈ کَرِو', uploadImage: 'تصویر اپلوڈ', useCamera: 'کیمرا', supportedFormats: 'JPG, PNG, WebP', maxFileSize: '10 MB', blurryWarning: 'تصویر دھندلی۔', predictDisease: 'بیماری پیشگوئی 🔍', confidence: 'اعتماد', cropSchedule: 'فصل شیڈول', nextCropRotation: 'اگلی فصل', recommendedFertilizers: 'کھاد', preventionTreatment: 'علاج', fertilizerSuggestion: 'کھاد مشورٕ', weatherIntegration: 'موسم', voiceInput: 'آواز اِنپُٹ', cropRotationPlanner: 'فصل چکر', smsAlerts: 'SMS الرٹ', cropScheduleFeature: 'فصل شیڈول', fertilizerYield: 'پیداوار کھاد', diseaseStage: 'بیماری مرحلہ', imageQuality: 'تصویر معیار', appLanguage: 'ایپ زبان', chooseLanguage: 'زبان مُنتَخب کَرِو۔', saveSettings: 'سیٹِنگز محفوظ', myProfile: 'پروفائل', updateProfile: 'اَپڈیٹ', phoneNumber: 'فون نمبر', email: 'ای میل', footerDesc: 'AI فصل سفارش', allRightsReserved: '© 2026 Agro_Guardian.', selectLocation: 'نقشہ مقام', mapTitle: 'ہِندوستان نقشہ' },
  sd: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'لاگ ان', signup: 'سائن اپ', logout: 'لاگ آئوٽ', back: 'واپس', save: 'محفوظ ڪريو', settings: 'سيٽنگون', profile: 'پروفائل', language: 'ٻولي', heroTitle: 'AI ذھانت سان ھاريءَ کي طاقتور بڻائڻ', heroDesc: 'ذاتي فصل سفارشون ۽ فوري بيماري اڳڪٿي حاصل ڪريو.', getStarted: 'شروع ڪريو — مفت', loginTitle: 'Agro_Guardian ۾ لاگ ان', signupTitle: 'اڪائونٽ ٺاھيو', emailOrPhone: 'اي ميل يا فون', password: 'پاسورڊ', fullName: 'پورو نالو', phone: 'فون', emailOptional: 'اي ميل (اختياري)', state: 'رياست', district: 'ضلعو', createPassword: 'پاسورڊ ٺاھيو', createAccount: 'اڪائونٽ ٺاھيو', continueWithGmail: 'Gmail سان جاري رکيو', signupWithGmail: 'Gmail سان سائن اپ', selectState: 'رياست چونڊيو', yourDistrict: 'توھان جو ضلعو', welcomeFarmer: 'ڀلي ڪري آيا، ھاري! 🌾', chooseService: 'سروس چونڊيو', cropRecommendation: 'فصل سفارش', cropRecommendationDesc: 'AI فصل صلاح.', cropDiseasePrediction: 'فصل بيماري اڳڪٿي', cropDiseaseDesc: 'فصل تصوير اپلوڊ ڪريو.', chooseMode: 'موڊ چونڊيو', simpleMode: 'سادو موڊ', simpleModeDesc: 'بنيادي معلومات.', advancedMode: 'ماھر موڊ', advancedModeDesc: 'تفصيلي سائنسي.', soilType: 'مٽيءَ جو قسم', budget: 'بجيٽ (₹)', weatherLocation: 'موسم/جاءِ', season: 'موسم', getRecommendation: 'سفارش حاصل ڪريو 🌱', nitrogen: 'نائٽروجن %', phosphorus: 'فاسفورس %', potassium: 'پوٽاشيم %', temperature: 'گرمائش °C', humidity: 'نمي %', phValue: 'pH', rainfall: 'مينھ mm', analyzeRecommend: 'تجزيو 🔬', uploadOrCapture: 'فصل فوٽو اپلوڊ', clickToUpload: 'اپلوڊ ڪريو', uploadImage: 'تصوير اپلوڊ', useCamera: 'ڪئميرو', supportedFormats: 'JPG, PNG, WebP', maxFileSize: '10 MB', blurryWarning: 'تصوير ڌنڌلي.', predictDisease: 'بيماري اڳڪٿي 🔍', confidence: 'اعتماد', cropSchedule: 'فصل شيڊول', nextCropRotation: 'ايندڙ فصل', recommendedFertilizers: 'کاد', preventionTreatment: 'علاج', fertilizerSuggestion: 'کاد صلاح', weatherIntegration: 'موسم', voiceInput: 'آواز ان پٽ', cropRotationPlanner: 'فصل چڪر', smsAlerts: 'SMS الرٽ', cropScheduleFeature: 'فصل شيڊول', fertilizerYield: 'پيداوار کاد', diseaseStage: 'بيماري مرحلو', imageQuality: 'تصوير معيار', appLanguage: 'ايپ ٻولي', chooseLanguage: 'ٻولي چونڊيو.', saveSettings: 'سيٽنگون محفوظ', myProfile: 'پروفائل', updateProfile: 'اپڊيٽ', phoneNumber: 'فون نمبر', email: 'اي ميل', footerDesc: 'AI فصل سفارش', allRightsReserved: '© 2026 Agro_Guardian.', selectLocation: 'نقشي تي جاءِ', mapTitle: 'ھندستان نقشو' },
  bo: { ...({} as TranslationKeys), appName: 'Agro_Guardian', login: 'Login', signup: 'Sign Up', logout: 'Logout', back: 'Back', save: 'Save', settings: 'Settings', profile: 'Profile', language: 'Language', heroTitle: 'AI Intelligence गोदान हालो सोलोंथाइनो खामानि', heroDesc: 'Crop recommendations and disease predictions.', getStarted: 'Start — Free', loginTitle: 'Agro_Guardian Login', signupTitle: 'Create Account', emailOrPhone: 'Email/Phone', password: 'Password', fullName: 'Full Name', phone: 'Phone', emailOptional: 'Email (optional)', state: 'State', district: 'District', createPassword: 'Create Password', createAccount: 'Create Account', continueWithGmail: 'Continue with Gmail', signupWithGmail: 'Sign up with Gmail', selectState: 'Select state', yourDistrict: 'Your district', welcomeFarmer: 'Welcome, Farmer! 🌾', chooseService: 'Choose a service', cropRecommendation: 'Crop Recommendation', cropRecommendationDesc: 'AI-powered crop suggestions.', cropDiseasePrediction: 'Crop Disease Prediction', cropDiseaseDesc: 'Upload crop image for AI diagnosis.', chooseMode: 'Choose input mode', simpleMode: 'Simple Mode', simpleModeDesc: 'Basic info input.', advancedMode: 'Advanced Mode', advancedModeDesc: 'Detailed scientific input.', soilType: 'Soil Type', budget: 'Budget (₹)', weatherLocation: 'Weather/Location', season: 'Season', getRecommendation: 'Get Recommendation 🌱', nitrogen: 'Nitrogen (N) %', phosphorus: 'Phosphorus (P) %', potassium: 'Potassium (K) %', temperature: 'Temperature (°C)', humidity: 'Humidity (%)', phValue: 'pH Value', rainfall: 'Rainfall (mm)', analyzeRecommend: 'Analyze & Recommend 🔬', uploadOrCapture: 'Upload or capture crop photo', clickToUpload: 'Click to upload', uploadImage: 'Upload Image', useCamera: 'Use Camera', supportedFormats: 'Formats: JPG, PNG, WebP', maxFileSize: 'Max: 10 MB', blurryWarning: 'Image may be blurry.', predictDisease: 'Predict Disease 🔍', confidence: 'Confidence', cropSchedule: 'Crop Schedule', nextCropRotation: 'Next Crop Rotation', recommendedFertilizers: 'Recommended Fertilizers', preventionTreatment: 'Prevention & Treatment', fertilizerSuggestion: 'Fertilizer Suggestion', weatherIntegration: 'Weather Integration', voiceInput: 'Voice Input', cropRotationPlanner: 'Crop Rotation Planner', smsAlerts: 'SMS Alerts', cropScheduleFeature: 'Complete Crop Schedule', fertilizerYield: 'Fertilizer for Yield', diseaseStage: 'Disease Stage & Infection', imageQuality: 'Image Quality Analyzer', appLanguage: 'App Language', chooseLanguage: 'Choose your preferred language.', saveSettings: 'Save Settings', myProfile: 'My Profile', updateProfile: 'Update Profile', phoneNumber: 'Phone Number', email: 'Email', footerDesc: 'AI-powered crop recommendation & disease prediction', allRightsReserved: '© 2026 Agro_Guardian. All rights reserved.', selectLocation: 'Select location on map', mapTitle: 'India Map — Select Region' },
};
